...
const categories = [
  { value: 'travel', label: 'Travel', desc: 'Transport & commute', icon: faPlane },
  ...
  { value: 'equipment', label: 'Equipment', desc: 'Tools & devices', icon: faLaptop },
...
const ManagerApplyReimbursement = ({ onApplied }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(response.message || 'Reimbursement submitted — awaiting admin approval');
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200">
      ...
      <div className="px-6 py-3 border-b border-gray-100 bg-gray-50 rounded-t-lg">
        <p className="text-xs text-gray-500">Manager reimbursements are reviewed directly by Admin.</p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="px-6 py-5 border-b border-gray-100">
          ...
          <div className="flex items-center justify-between mt-1.5">
            <p className="text-[11px] text-gray-400">Keep it concise</p>
        ...
        <div className="px-6 py-5 border-b border-gray-100">
          ...
          <textarea
            ...
            maxLength={1000}
            rows={4}
            className="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent placeholder:text-gray-400 resize-none"
            required
          />
...
export default ManagerApplyReimbursement;
