...
const ManagerApplyLeave = ({ onLeaveApplied }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(response.message || 'Leave request submitted — pending admin approval');
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="px-6 py-5 border-b border-gray-100">
          ...
          <div className="flex items-center justify-between mt-1.5">
            <p className="text-[11px] text-gray-400">Your leave request will be reviewed by an admin</p>
